package com.example.oauth2_test.config.oauth;

import com.example.oauth2_test.config.auth.PrincipalDetails;
import com.example.oauth2_test.config.oauth.provider.GoogleUserInfo;
import com.example.oauth2_test.config.oauth.provider.NaverUserInfo;
import com.example.oauth2_test.config.oauth.provider.OAuth2UserInfo;
